...
![Пример отчёта](screenshots/screenshot_insights.png)
...
Типичные рекомендации, которые генерирует система (локальный режим без внешнего API):

- **Выручка растёт** (позитивный инсайт)  
  *«Вторая половина периода принесла на 15% больше чем первая. Хороший сигнал — продолжай в том же духе и анализируй что изменилось.»*

- **Локомотив продаж — Капучино** (позитивный инсайт)  
  *«Этот товар приносит наибольшую выручку. Убедись что он всегда в наличии, рассмотри расширение линейки на его основе.»*

- **Кандидаты на вывод из ассортимента** (предупреждение)  
  *«Товары Маффин, Сок вносят минимальный вклад в выручку. Они занимают место и отвлекают внимание. Рассмотри их замену.»*

- **Лучший день — Чт, худший — Пн** (нейтральный инсайт)  
  *«Планируй акции и запасы под пиковые дни. В Пн попробуй специальные предложения чтобы поднять выручку.»*
